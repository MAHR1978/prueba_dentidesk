...
//Ejecuto la función al cargar la página
	...
	function ver_costos()
	{
	  ...
	  $('#table_costo tbody').find('tr').each(function (i, el) {
		...
		//$('#table_venta tfoot tr th').eq(0).text("Total " + total_col1);
		$('#table_costo tfoot tr th').eq(1).text("Total " + total_col2);
	...
	function por_mes()
	{
		...
		{
			$("#det_costos_por_mes").submit();
		}
	}
</script>
<div class="panel panel-default">
        <div align="center" class="panel-heading"><h2>detalles insumo<h2></div>
</div>
<nav class="navbar navbar-default" role="navigation" width="80%">
	<a class="nav-link" id="pormes" href="#" onclick="pormes()">costos por mes</a>
	<a class="nav-link" href="inicio">inicio</a>
</nav>
<div class="container">
	<form id="det_costos_por_mes"  method="post" action="{{route('costos_por_mes')}}" >
		@csrf
 ...
 <div class="card card-body">
	<div class="table-responsive"> 
		<table class="table detalle_productos" style="" id="table_costo">
			<thead>
				<tr>
					<th>insumo</th>
					<th>valor insumo</th>
	...
	<div class="row">
		<button type="button" class="btn btn-primary" onclick="ver_costos()" >ver total</button>
    </div>
</div>