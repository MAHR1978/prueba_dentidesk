...
//Ejecuto la función al cargar la página
	$(document).ready(function()
	{
	  ...
	  //Defino los totales de mis 2 columnas en 0
		...
		$('#table_venta tbody').find('tr').each(function (i, el) {
		...
		$('#table_venta tfoot tr th').eq(1).text("Total " + total_col2);
...
<div class="panel panel-default">
        <div align="center" class="panel-heading"><h2>detalles venta<h2></div>
</div>
...
<div class="container">
 ...
 <div class="card card-body">
	<div class="table-responsive"> 
		<table class="table detalle_productos" style="" id="table_venta">
			<thead>
				<tr>
					<th>Producto</th>
					<th>precio</th>
