...
<script type="text/javascript">	
	$(document).ready(function(){
		...
		//$('#table_costo tfoot tr th').eq(0).text("Total " + total_col1);
...
<div class="panel panel-default">
        <div align="center" class="panel-heading"><h2>detalles costos<h2></div>
</div>
<nav class="navbar navbar-default" role="navigation" width="80%">
	<a class="nav-link" id="pormes" href="#">costos por mes</a>
